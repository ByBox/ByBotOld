...
# /(aluminium|essential|elegant|efficient|experience|incredible|magical|meticulous|unibody|from the ground up)/

module.exports = (robot) ->
  robot.hear /(aluminium|elegant|magical|meticulous|unibody|from the ground up)/i, (msg) ->
